...
For ```Vulkan-loader-9999.ebuild``` check to see if their latest version is working:

- [Vulkan-loader actions](https://github.com/KhronosGroup/Vulkan-Loader/actions)
